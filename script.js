...
if(chatbox.classList.contains("active-chat-box")){
 ...
 let Api_url= "https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash-latest:generateContent?key=AIzaSyAZV1izaye2WDiYzHuZTOtB5o3lzgIHriQ"
...
if(message.includes("open") && message.includes("chat")){
  ...
  speak("i am virtual assistant ,created by Tanya mam")
